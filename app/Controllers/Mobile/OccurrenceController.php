...
/**
 * Ocorrências mobile: redireciona para a página completa com from_mobile=1
 * para a mesma vista (pages/occurrences/index.html.twig) ser renderizada com o template mobile.
 */
class OccurrenceController extends Controller
{
    public function index(): void
    {
        ...
        header('Location: ' . BASE_URL . 'condominiums/' . $condominiumId . '/occurrences?' . http_build_query($params));
        exit;
    }
}
